...
.index-container {
  ...
  .index-wrapper {
    width: 100%;
    background: url('../assets/index-bg.jpeg') no-repeat fixed center top;
    ...
    .main-glitch:hover {
      ...
      text-shadow: 8px 8px 1px rgba(44, 46, 47, 0.1);
    }
  }
  .index-wrapper::after {
    content: '';
    background: url('../assets/dot.gif') 0 0 fixed;
    position: absolute;
    top: 0;
    right: 0;
    left: 0;
